...
Le rôle \`PEDAGOGICAL\_MANAGER\` peut être cumulé avec \`TEACHER\`.  
...
\- obligatoire pour \`SUPER\_ADMIN\` ;  
\- obligatoire ou fortement recommandé pour \`ADMIN\` ;  
\- obligatoire ou recommandé pour \`PEDAGOGICAL\_MANAGER\` ;  
