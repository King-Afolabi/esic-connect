...
const KNOWN_CODES = new Set<string>([
  ...
  'SESSION_SUBJECT_NOT_FOUND',
  'SESSION_SUBJECT_INACTIVE',
  'SESSION_ROOM_NOT_FOUND',
  'SESSION_TEACHER_DOUBLE_BOOKING',
  'SESSION_ROOM_DOUBLE_BOOKING',
  // Modalité et lien distant (Lot 11).
  'SESSION_REMOTE_LINK_REQUIRED',
  'SESSION_INVALID_REMOTE_LINK',
  // Départ anticipé (EF-ATT-013) et analyse antivirus (EF-JUS-002).
  'ATT_EARLY_DEPARTURE_NOT_FOUND',
  'ATT_EARLY_DEPARTURE_INVALID_STATE',
  'ATT_EARLY_DEPARTURE_ALREADY_OPEN',
  'ATT_EARLY_DEPARTURE_DECISION_RESERVED',
  'ATT_EARLY_DEPARTURE_TIME_OUTSIDE_SESSION',
  'ATT_ATTACHMENT_INFECTED',
  'ATT_ATTACHMENT_QUARANTINED',
  ...
  'ATT_ATTACHMENT_NOT_FOUND',
  'ATT_ATTACHMENT_ALREADY_EXISTS',
  'ATT_ATTACHMENT_STORAGE_FAILED',
  'ATT_ATTACHMENT_TOO_LARGE',
  'ATT_ATTACHMENT_EMPTY',
  'ATT_ATTACHMENT_UNSUPPORTED',
